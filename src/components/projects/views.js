        ...
        >
            ...
            <Modal.Body style={{ color: "white", backgroundColor: "#000000b7" }}>
                <div class="d-flex justify-content-center  mb-3">
                    <ReactPlayer url="https://youtu.be/VbLSJwMfoW8" playing />
                </div>
            </Modal.Body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 md-4 text-center">
                            ...
                            <p class='mt-2'> Motion graphic animation use in reality televison pliot for Vibes and Views.  </p>
...
function ViewsModal() {
    ...
    return (
        <div>
            ...
            />
            <Views show={modalShowNyx} onHide={() => setModalShowNyx(false)} />
        </div>
    )
}

export default class ViewsVideo extends Component {
    constructor(props) {
        super(props)
